...
def get_android_ndk_root(env: "SConsEnvironment"):
    if os.environ.get("ANDROID_NDK_ROOT") and os.path.exists(os.environ.get("ANDROID_NDK_ROOT")):
        return os.environ.get("ANDROID_NDK_ROOT")
    if os.environ.get("ANDROID_NDK_HOME") and os.path.exists(os.environ.get("ANDROID_NDK_HOME")):
        return os.environ.get("ANDROID_NDK_HOME")
    ndk_dir = os.path.join(env["ANDROID_HOME"], "ndk")
    preferred = os.path.join(ndk_dir, get_ndk_version())
    ...
    if os.path.exists(ndk_dir):
        ...
        if ndk_versions:
            ...
            return os.path.join(ndk_dir, ndk_versions[0])
    return preferred
